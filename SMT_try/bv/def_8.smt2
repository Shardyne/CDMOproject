...
(assert
 ...
 (let ((?x6782 (+ ?x6775 ?x6776 ?x6777 ?x6778 ?x6779 ?x6780 ?x6781)))
 (let ((?x6848 (- (* 2 ?x6782) 7)))
 (let ((?x6887 (+ (ite (> ?x6848 0) ?x6848 (- ?x6848)) (ite (> ?x6853 0) ?x6853 (- ?x6853)) (ite (> ?x6858 0) ?x6858 (- ?x6858)) (ite (> ?x6863 0) ?x6863 (- ?x6863)) (ite (> ?x6868 0) ?x6868 (- ?x6868)) (ite (> ?x6873 0) ?x6873 (- ?x6873)) (ite (> ?x6878 0) ?x6878 (- ?x6878)) (ite (> ?x6883 0) ?x6883 (- ?x6883)))))
 (< ?x6887 10)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (= Home_0_0 true))
(assert
